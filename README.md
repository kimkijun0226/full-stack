...
2. [프로젝트 구조](#프로젝트-구조)
3. [환경 변수 설정](#환경-변수-설정)
4. [Supabase 테이블 구조 & SQL](#supabase-테이블-구조--sql)
5. [API 레이어](#api-레이어)
6. [커스텀 훅](#커스텀-훅)
7. [전역 상태 (Zustand)](#전역-상태-zustand)
8. [쿼리 키 팩토리](#쿼리-키-팩토리)
9. [공통 컴포넌트](#공통-컴포넌트-appxxx)
10. [UI 컴포넌트 (shadcn/ui)](#ui-컴포넌트-shadcnui)
11. [페이지 라우팅](#페이지-라우팅)
12. [만든 과정](#만든-과정)
